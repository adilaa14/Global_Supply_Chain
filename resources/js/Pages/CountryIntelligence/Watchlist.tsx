                                            ...
                                            <td>
                                                <div className="d-flex align-items-center gap-3">
                                                    <div className="d-flex align-items-center justify-content-center bg-light rounded overflow-hidden shadow-sm" style={{ width: '40px', height: '30px' }}>
                                                        {country.iso_code && (
                                                            <img 
                                                                src={`https://cdn.jsdelivr.net/gh/lipis/flag-icons@7.0.0/flags/4x3/${country.iso_code.toLowerCase()}.svg`} 
                                                        ...
                                                        <span style={{ fontSize: '20px', display: country.iso_code ? 'none' : 'block' }}>
                                                            {country.flag || '🏳️'}
                                                        </span>
                                                    </div>
                                                    <div>
