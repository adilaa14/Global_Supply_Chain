            ...
            <div className="app-container">
                ...
                <aside className="sidebar fade-up" style={{ animationDelay: '0.1s' }}>
                    ...
                    <ul className="sidebar-menu">
                        ...
                        <li><Link href={route('trade.index')} className={route().current('trade.*') && !route().current('trade.simulation') ? 'active' : ''}><span className="material-symbols-outlined">query_stats</span> <span className="nav-text">Trade Intelligence</span></Link></li>
                        <li><Link href={route('trade.simulation')} className={route().current('trade.simulation') ? 'active' : ''}><span className="material-symbols-outlined">calculate</span> <span className="nav-text">Profit Simulation</span></Link></li>
